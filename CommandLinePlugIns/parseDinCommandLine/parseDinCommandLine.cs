...
//using UserServices.UserAttributedLib;
    ...
    public class parseDinCommandLine : CommandLineRun
    {
        ...
        /// 
        /// </summary>
        private static parseDinCommandLine _parseCommand;
        public static parseDinCommandLine CountCommand { get { return _parseCommand; } } // Объект для доступа
        ...
        {
            Console.WriteLine($"{AppName} вызов команды /parseDin -pathbase={pathbase}  -pathconfig={pathconfig} -targethost={targethost} .");
        }
        ...
        public override void RulesOfchallenge()
        {
            ...
            Console.WriteLine($"{AppName} /parseDin -pathbase=pathprogram  -pathconfig=pathlocal -targethost=host ");
            Console.WriteLine("Например, {0} с командой parseDin можно запустить: ", AppName);
            Console.WriteLine(AppName,
               @" /parseDin -pathbase=C:\work\my_exe\ -pathconfig=C:\work\my_parse\ -targethost=en.wikipedia.org");
